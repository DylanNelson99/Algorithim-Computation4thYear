...
public:
	static string encode_input_text_to_file(const string& input, ofstream& out_file, HuffmanTree*& huffman_tree_out);					
	static HuffmanTree* encode_input_file_to_file(ifstream& in_file, ofstream& out_file);

	static string decode_input_text_to_file(const string& input, ofstream& out_file, const HuffmanTree* huffman_tree);					
